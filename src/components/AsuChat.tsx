...
import { Send, Bot, Loader2, Trash2, X } from 'lucide-react';
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-md p-0 gap-0">
        <DialogHeader className="bg-primary/10 border-b border-border px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <DialogTitle className="text-sm font-semibold">Chat with Asu</DialogTitle>
